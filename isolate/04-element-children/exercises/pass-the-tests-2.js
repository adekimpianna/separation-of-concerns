...
// --- write some code ---
const valueHref = divEl.children[0];
valueHref.setAttribute('href', '#top'); // setAttribute('type of attribute', 'value')
const valueBtn = setAtt.children[0];
valueBtn.innerHTML = 'to the top';
